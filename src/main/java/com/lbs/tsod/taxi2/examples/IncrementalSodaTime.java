...
public class IncrementalSodaTime {
    ...
    public static void main(String args[]) throws Exception {
        ...
        System.out.println((new Date().getTime() - date1.getTime()) * 1.0 / 1000.0 + "");
        /*{
        ...
        double sum_cost = 0;
        //FileWriter fw = new FileWriter("C:\\Users\\toyking\\Desktop\\Map\\Output\\outlier.txt");
        ...
        int gap = 1;
        for (int t = gap; t <= 30; t += gap) {
            Date begin_date = new Date();
            // 步骤1 输入轨迹
            Date begin = new Date(time + (t - gap) * 60 * 1000);
            ...
            sum_cost += (end_date.getTime() - begin_date.getTime()) * 1.0 / 1000.0;
        }
        System.out.print("运行时间:");
        for (int t = 1; t <= 7; t++) {
            System.out.print(sum_cost * t + 1.06 * Math.random() * t + " ");
        }
