...
/**
 * Created by toyking on 2016/6/1.
 */
public class EvilTransform {
    ...
    public static Coordinate transform(double wgLon, double wgLat) {
        Coordinate coordinate = new Coordinate(wgLat, wgLon);
        ...
        coordinate.y = wgLat + dLat;
        coordinate.x = wgLon + dLon;
        return coordinate;
    }
