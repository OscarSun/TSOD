...
import com.lbs.tsod.animal.algorithm.DensityCaculate;
import com.lbs.tsod.animal.algorithm.LAFD;
import com.lbs.tsod.animal.algorithm.TrajectorySimplify;
import com.lbs.tsod.animal.file.Input;
import com.lbs.tsod.animal.model.TFragment;
import com.lbs.tsod.animal.model.Trajectory;
...
//检测动物数据ELK
public class NaiveMaoDEER1995 extends Applet {
