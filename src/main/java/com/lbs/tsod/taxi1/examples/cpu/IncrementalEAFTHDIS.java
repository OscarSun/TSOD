 ...
 */
public class IncrementalEAFTHDIS {
    ...
    public static void main(String args[]) throws Exception {
        ...
        for (double TH_DIST = 2E-4; TH_DIST <= 1E-1; TH_DIST = TH_DIST * 2) {
            ...
            for (int k = 0; k < 7; k++) {
                ...
                //for (int t = 30; t <= InputParameter.time_max; t += 30) {
                    ...
                    for (int object_id : snapshot_ILAF.keySet()) {
                        ...
                        double eaf = avg * 1 * 1 / (InputParameter.time_max * InputParameter.time_max);
                        double sum = 0;
