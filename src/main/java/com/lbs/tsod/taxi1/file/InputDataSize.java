...
public class InputDataSize {
    ...
    public static void main(String args[]) throws Exception {
        ...
        // 写入文件
        {
            FileWriter fw = new FileWriter(PATH + "outlier_trajectories_dataSize.txt");
    ...
    public static List<Trajectory> getTaxi() throws Exception {
        ...
        {
            BufferedReader br = new BufferedReader(new FileReader(PATH + "outlier_trajectories_dataSize.txt"));
            br.readLine();
