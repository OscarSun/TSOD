...
public class Input {
    ...
    public static void main(String args[]) throws Exception {
        ...
        // 写入文件
        {
            FileWriter fw = new FileWriter(PATH + "outlier_trajectories_speed.txt");
    ...
    public static List<Trajectory> getTaxi() throws Exception {
        ...
        {
            BufferedReader br = new BufferedReader(new FileReader(PATH + "outlier_trajectories_speed.txt"));
