...
public class InputParameter {
    ...
    public static void main(String args[]) throws Exception {
        ...
        // 写入文件
        {
            FileWriter fw = new FileWriter(PATH + "outlier_trajectories_parameter.txt");
    ...
    public static List<Trajectory> getTaxi() throws Exception {
        ...
        {
            BufferedReader br = new BufferedReader(new FileReader(PATH + "outlier_trajectories_parameter.txt"));
            br.readLine();
    ...
    public static List<Trajectory> getOutlier() throws Exception {
        List<Trajectory> result = new ArrayList<Trajectory>();
        List<Trajectory> list = getTaxi();
