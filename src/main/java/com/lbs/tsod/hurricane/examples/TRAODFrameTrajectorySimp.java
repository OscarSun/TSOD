...
import com.lbs.tsod.hurricane.algorithm.Partition;
...
public class TRAODFrameTrajectorySimp extends Applet {
    ...
    public void init() {
        ...
        simplified_trajs = new ArrayList<Trajectory>();
        {
            for (Trajectory traj : input_trajs) {
                ...
                simplified_trajs.add(simplify.getTrajectoryPartition());
            }
        }
