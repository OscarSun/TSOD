...
public class MaoTRAOD {
    public final static double D = 85;
    public static double TH_DILTA = 85;
    public final static double p = 0.95;
    public final static double wV = 0.15D;
    public final static double wH = 0.15D;
    public final static double wX = 0.70D;
    ...
    public static void main(String args[]) throws Exception {
        ...
        List<Trajectory> simplifiedTrajs = new ArrayList<Trajectory>();
        {
            for (Trajectory traj : input_trajs) {
                ...
                simplifiedTrajs.add(simplify.getSimplifiedTrajectoty());
            }
        }
        /*{
        ...
        List<TFragment> fragments = new ArrayList<TFragment>();
        {
            ...
            System.out.println("标准差是:" + TH_DILTA + " " + list_dis.size());
        ...
        Trajectory trajectory = input_trajs.get(2);
        RoutePainter painter = JxmapHelper.getRoutePainter(trajectory);
        painter.setColor(Color.GREEN);
        painters.add(painter);
        ...
        RoutePainter painter2 = JxmapHelper.getRoutePainter(trajectory);
